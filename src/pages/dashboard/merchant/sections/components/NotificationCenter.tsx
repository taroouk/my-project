    ...
    <div className="relative" dir={dir}>
      ...
      {isOpen && (
        <>
          ...
          <div className="absolute right-0 mt-4 w-[340px] bg-white shadow-2xl rounded-[2.5rem] border border-gray-50 z-50 overflow-hidden">
              ...
              {notifications.length === 0 ? (
                ...
                notifications.map((n) => (
                  ...
                  >
                    ...
                    >
                      {n.type === 'booking' ? <Calendar size={18} /> : n.type === 'stock' ? <Package size={18} /> : <Info size={18} />}
                    </div>
